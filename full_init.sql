USE master;
GO
IF EXISTS (SELECT * FROM sys.databases WHERE name = 'CafeDB')
BEGIN
...
CREATE DATABASE [CafeDB] ON PRIMARY 
(NAME=CafeDB_data, FILENAME = 'c:\Users\l227628\Downloads\CafeSystem\CafeSystem\App_Data\CafeDB.mdf') 
LOG ON 
(NAME=CafeDB_log, FILENAME = 'c:\Users\l227628\Downloads\CafeSystem\CafeSystem\App_Data\CafeDB_log.ldf');
GO
